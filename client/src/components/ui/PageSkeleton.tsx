  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm space-y-4"
      >
...
export function CalculatorPageSkeleton() {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="space-y-8 max-w-6xl mx-auto py-6"
    >
      ...
      <motion.div
        variants={itemVariants}
        className="bg-slate-900 rounded-3xl p-6 md:p-8 space-y-6 border border-slate-800"
      >
        <div className="flex items-center justify-between">
          <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 space-y-3"
          >
      ...
      <motion.div
        variants={itemVariants}
        className="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 space-y-4"
      >
...
export function FeedPageSkeleton() {
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="rounded-3xl bg-slate-900 p-8 md:p-12 space-y-4 border border-slate-800"
      >
      ...
      <div className="space-y-6">
        {Array.from({ length: 3 }).map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 grid grid-cols-1 lg:grid-cols-12 gap-6"
          >
...
export function BlogPageSkeleton() {
  return (
    ...
    >
      {/* Blog Title Skeleton */}
      <motion.div variants={itemVariants} className="text-center space-y-3 py-6">
      ...
      <motion.div
        variants={itemVariants}
        className="rounded-3xl bg-slate-900 p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 border border-slate-800"
      >
...
export function GenericPageSkeleton() {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="max-w-5xl mx-auto py-10 space-y-6"
    >
      <motion.div variants={itemVariants}>
