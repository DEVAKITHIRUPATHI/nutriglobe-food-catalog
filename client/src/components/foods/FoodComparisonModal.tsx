...
export const FoodComparisonModal: React.FC<FoodComparisonModalProps> = ({
  ...
  const nutA = useMemo(() => ({
    ...
    sugar: Math.round((foodA.nutrition.sugar || 0) * scaleA * 10) / 10,
    water: Math.round((foodA.nutrition.waterContent || 80) * scaleA),
  ...
  const nutB = useMemo(() => ({
    ...
    sugar: Math.round((foodB.nutrition.sugar || 0) * scaleB * 10) / 10,
    water: Math.round((foodB.nutrition.waterContent || 80) * scaleB),
